...
public class HealthFragment extends Fragment implements View.OnClickListener {
    ...
    private Switch sw_dentist, sw_eyetest, sw_hearing_test;
...
//    private EditText mContent, mTitle;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        fragment_view = inflater.inflate(R.layout.health_fragemnt, container, false);
        context = getActivity();
        linkViews();
    ...
    private void linkViews() {
        ...
        sw_dentist = fragment_view.findViewById(R.id.sw_dentist);
        sw_eyetest = fragment_view.findViewById(R.id.sw_eyetest);
        sw_hearing_test = fragment_view.findViewById(R.id.sw_hearing_test);
...
//        String plank = Utills.getPreferences(Constants.KEY_PLANK_REMINDER, context);
        ...
        for (int i = 0; i < appDataBase.getAllReminders().size(); i++) {
            ...
            if (title.equalsIgnoreCase("sw_dentist")) {
                sw_dentist.setChecked(true);
            } else {
//                sw_dentist.setChecked(false);
            }


            if (title.equalsIgnoreCase("sw_eyetest")) {
                sw_eyetest.setChecked(true);
            } else {
//                sw_eyetest.setChecked(false);
            }
...
//                sw_eyetest.setChecked(false);
            ...
            if (title.equalsIgnoreCase("sw_hearing_test")) {
                sw_hearing_test.setChecked(true);
            } else {
//                sw_hearing_test.setChecked(false);
            }
...
//        ListView listView = new ListView(context);
    ...
    private void loadReminders() {
        ...
        sw_dentist.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                setReminder(isChecked, "sw_dentist", Utills.getPreferences(Constants.sw_dentist, context), 600);
        ...
        sw_eyetest.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {

            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Log.v("Switch State=", "" + isChecked);

                setReminder(isChecked, "sw_eyetest", Utills.getPreferences(Constants.sw_eyetest, context), 200);

            }

        });

        sw_hearing_test.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {

            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Log.v("Switch State=", "" + isChecked);

                setReminder(isChecked, "sw_hearing_test", Utills.getPreferences(Constants.sw_hearing_test, context), 300);
    ...
    private void setReminder(boolean isChecked, String sw_tilte, String reminder, int reminder_frequency) {
