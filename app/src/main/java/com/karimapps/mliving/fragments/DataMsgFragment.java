...
public class DataMsgFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        fragment_view = inflater.inflate(R.layout.privacy_messages_fragemnt, container, false);
        linkViews();
