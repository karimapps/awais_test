...
public class MotivationFragment extends Fragment implements View.OnClickListener {
    ...
    private Switch sw_motivational420;
...
//    private EditText mContent, mTitle;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        fragment_view = inflater.inflate(R.layout.motiviation_fragemnt, container, false);
        context = getActivity();
        linkViews();
    ...
    private void linkViews() {
        ...
        sw_motivational420 = fragment_view.findViewById(R.id.sw_motivational420);
...
//        String plank = Utills.getPreferences(Constants.KEY_PLANK_REMINDER, context);
        ...
        for (int i = 0; i < appDataBase.getAllReminders().size(); i++) {
            ...
            if (title.equalsIgnoreCase("sw_motivational420")) {
                sw_motivational420.setChecked(true);
            } else {
//                sw_motivational420.setChecked(false);
            }
...
//        ListView listView = new ListView(context);
    ...
    private void loadReminders() {
        ...
        sw_motivational420.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                setReminder(isChecked, "sw_motivational420", "This is Motivational Quotes Reminder");
