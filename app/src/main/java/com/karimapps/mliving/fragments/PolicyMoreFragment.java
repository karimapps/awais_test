...
public class PolicyMoreFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        fragment_view = inflater.inflate(R.layout.policy_more_fragemnt, container, false);
        linkViews();
