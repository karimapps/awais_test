...
public class WelcomeMsgFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        fragment_view = inflater.inflate(R.layout.welcome_messages_fragemnt, container, false);
        linkViews();
