...
public class FoodFragment extends Fragment implements View.OnClickListener {
    ...
    private Switch sw_food786, sw_vegan120, sw_freashair_food, sw_water;
...
//    private EditText mContent, mTitle;
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        fragment_view = inflater.inflate(R.layout.food_fragemnt, container, false);
        context = getActivity();
        linkViews();
    ...
    private void linkViews() {
        ...
        sw_food786 = fragment_view.findViewById(R.id.sw_food786);
        sw_vegan120 = fragment_view.findViewById(R.id.sw_vegan120);
        sw_freashair_food = fragment_view.findViewById(R.id.sw_freashair_food);
        sw_water = fragment_view.findViewById(R.id.sw_water);
...
//        String plank = Utills.getPreferences(Constants.KEY_PLANK_REMINDER, context);
        ...
        for (int i = 0; i < appDataBase.getAllReminders().size(); i++) {
            ...
            if (title.equalsIgnoreCase("sw_food786")) {
                sw_food786.setChecked(true);
            } else {
//                sw_food786.setChecked(false);
            }


            if (title.equalsIgnoreCase("sw_vegan120")) {
                sw_vegan120.setChecked(true);
            } else {
//                sw_vegan120.setChecked(false);
            }
...
//                sw_vegan120.setChecked(false);
            ...
            if (title.equalsIgnoreCase("sw_freashair_food")) {
                sw_freashair_food.setChecked(true);
            } else {
//                sw_freashair_food.setChecked(false);
            }

            if (title.equalsIgnoreCase("sw_water")) {
                sw_water.setChecked(true);
            } else {
//                sw_water.setChecked(false);
            }
...
//        ListView listView = new ListView(context);
    ...
    private void loadReminders() {
        ...
        sw_food786.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                setReminder(isChecked, "sw_food786", "This is Food suggession Reminder");
        ...
        sw_vegan120.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {

            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Log.v("Switch State=", "" + isChecked);

                setReminder(isChecked, "sw_vegan120", "This is vegiterian Reminder");

            }

        });

        sw_freashair_food.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {

            @Override
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                Log.v("Switch State=", "" + isChecked);

                setReminder(isChecked, "sw_freashair_food", "This is Fresh Air Reminder");
        ...
        sw_water.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                ...
                setReminder(isChecked, "sw_water", "This is Water Reminder");
